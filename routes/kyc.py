...
from blockchain.kyc_logic import process_kyc_document, is_user_verified  # تم تعديل هذا السطر
...
def upload_kyc():
    ...
    # تمرير المسار والرقم التعريفي للدالة لمعالجة التحقق
    verification_result = process_kyc_document(user_id, save_path)
